        ...
        <div class="columns">
            <div class="column">
                <div class="control">
                    ...
                    <input class="input" type="text" name="ultima_fecha_mantenimiento" pattern="[0-9]{4}-(0?[1-9]|1[012])-(0?[1-9]|[12][0-9]|3[01])" maxlength="10" required value="<?php echo $datos['ultima_fecha_mantenimiento']; ?>">
                </div>
            </div>
        </div>
