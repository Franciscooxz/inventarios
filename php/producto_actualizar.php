<?php
    ...
    if($codigo=="" || $nombre=="" || $precio=="" || $stock=="" || $categoria=="" || $ultima_fecha_mantenimiento==""){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    if(!preg_match("/^\\d{4}\\-(0?[1-9]|1[012])\\-(0?[1-9]|[12][0-9]|3[01])$/", $ultima_fecha_mantenimiento)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    $actualizar_producto=$actualizar_producto->prepare("UPDATE producto SET producto_codigo=:codigo,producto_nombre=:nombre,producto_precio=:precio,producto_stock=:stock,categoria_id=:categoria,ultima_fecha_mantenimiento=:ultima_fecha_mantenimiento WHERE producto_id=:id");
